...
**Mostly closed by [[analysis-re-factor|Analysis re-factor]].** A struct may now hold itself, or
...
moved to [[bugs|Bugs]] — the cause turned out to be `typeLitStructCheck` comparing
...
## Two crashes, fixed in [[bugs|Bugs]]
