...
records what does work. Considered for [[compiler-defect-backlog|Compiler defect backlog]] and left
...
[[types-pointers-and-borrowed-references|Types. Pointers and Borrowed References]], under "Receiver adjustment". Design
the three together.
...
interned; see [[compiler-defect-backlog|Compiler defect backlog]].
