What `design/` still owes, after [[design-documentation|Design Documentation]] closed.
...
[[tag-group-and-name-aliasing-refactor|Tag Group and Name Aliasing Refactor]]. It also lacks the provenance line every
...
Found by [[bugs|Bugs]], while fixing two defects whose repairs the corpus has no way
to pin.
...
[[vault-and-repo-sync|Vault and repo sync]] — done. The duplicate vault copies of these notes are
