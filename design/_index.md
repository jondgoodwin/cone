...
| Document | Contents |
| --- | --- |
| [IR Nodes](IR%20Nodes.md) | Overview of compiler IR node groups, the major node tags used across semantic passes, and the common source-location and node metadata fields. |
