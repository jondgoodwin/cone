...
| Document | Contents |
| --- | --- |
| [Analysis](Analysis.md) | How name resolution, type checking and flow analysis run: what demand means, the two marks a declaration carries, what a declaration under analysis can answer about its type and its size, and the resolution order within each declaration kind. |
